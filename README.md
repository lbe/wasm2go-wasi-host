...
The primary goal of this project is to provide a WASI implementation to be used with packages generated by wasm2go that is compliant with with the [WASI preview 1](https://github.com/WebAssembly/WASI/blob/wasi-0.1/preview1/docs.md) specification. It implements all 40 WASI preview1 functions plus the `env.call_host_function` stub required by certain modules.
